...
const Index = ({ auth, myproyects }) => {
    // Invertir el arreglo para mostrar los proyectos del último al primero
    const reversedProyects = [...myproyects].reverse();
            ...
            <div className="py-12 items-center justify-center">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg ">
                        <div className='m-4'>
                            <Link href={route('myproyects.create')}>
                            ...
                            <div>
                                {
                                    reversedProyects?.map(proyect => (
                                        <div key={proyect.id} className="max-w bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-700 dark:border-gray-700 m-10">
                                            ...
                                            <div className="p-5">
                                                <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Proyecto: {proyect.name}</h5>
                                                ...
                                                <Link href={route('myproyects.edit', [proyect])}>
                                                ...
                                                <Link href={route('myproyects.destroy', [proyect])} method='delete'>
